...
const AdminProductCard = ({ data, fetchData }) => {
  ...
  return (
    <div className="border p-4 bg-white rounded w-64 h-65 flex flex-col items-center">
      <img 
      ...
      <div className='flex justify-between items-center w-full mt-2'>
        <h1 className='font-bold text-center text-ellipsis line-clamp-2'>{data?.productName}</h1>
        <div 
