...
text-white'><IoSearchSharp /></div></div>
        <div className='flex items-center gap-7'>
          ...
          <div>
            {
              user?._id ? (<button onClick={userLogout} className="px-3 py-1 bg-primary text-white rounded-full hover:bg-secondary">logout</button>) : (
                <Link to={"/login"} className="px-3 py-1 bg-primary text-white rounded-full hover:bg-secondary"> login</Link>
              )
            }
          </div>
        </div>
