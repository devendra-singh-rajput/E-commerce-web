...
text-white'><IoSearchSharp /></div></div>
       <div className='flex items-center gap-7'> 
        ...
        <div className='bg-red-600 text-white p-1 flex items-center justify-center w-5 h-5 rounded-full -top-2 -right-3 absolute'>
          <p className='text-sm'>0</p>
        </div>
        </div>

        <div>
          <Link to={"/login"} className="px-3 py-1 bg-red-600 text-white rounded-full hover:bg-red-700">
            login
          </Link>
        </div>
       </div>
