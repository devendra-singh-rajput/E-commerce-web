        ...
        {loading ? (
          ...
          data.map((product, index) => (
            ...
            >
              ...
              <div className="bg-slate-200  h-48 min-w-[280px] md:min-w-[145px] w-full overflow-x-auto  space-x-4  snap-both snap-mandatory scrollbar-none flex">
                {product.productImage.map((src, index) => (
                  <div
                    key={index}
                    className="w-full p-4 mix-blend-multiply h-48 snap-center flex items-center flex-shrink-0   justify-center transition-transform duration-300 ease-in-out transform hover:scale-105 "
                  >
                    <img
                      src={src}
                      alt={product.name}
